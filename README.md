...
- **Delete Members:** Click the delete icon on a member card to remove them (Admins cannot delete their own account). If the member has active tasks assigned, a safety warning will appear confirming that proceeding will also permanently delete all of their assigned tasks in a cascading fashion.
