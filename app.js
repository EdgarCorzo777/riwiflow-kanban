...
async function router() {
  ...
  if (hash === '#/login') renderLoginView(container);
  else if (hash === '#/dashboard') renderDashboardView(container, 'board');
  else if (hash === '#/team') renderDashboardView(container, 'team');
  ...
  container.innerHTML = `
    <aside class="hidden md:flex flex-col pt-md pb-xl gap-xs h-full bg-surface-container-low border-r border-outline-variant w-[280px] shrink-0">
      ...
      <nav class="flex-1 space-y-1">
        ...
        <a class="flex items-center text-secondary hover:text-primary hover:bg-primary-container/10 px-4 py-3 mx-2 font-body-sm text-body-sm rounded-lg transition-all" href="#/dashboard">
